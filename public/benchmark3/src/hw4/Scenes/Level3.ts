...
export default class Level3 extends HW4Scene {
    ...
    public override loadScene() {
        ...
        this.load.object("keys", "hw4_assets/data/items/level3keys.json");
        this.load.object("vents", "hw4_assets/data/items/level3vents.json");
        this.load.object("safes", "hw4_assets/data/items/level3safes.json");
        this.load.object("obstacles", "hw4_assets/data/items/level3obstacles.json");
        this.load.object("lockers", "hw4_assets/data/items/level3lockers.json");
        this.load.object("electricities", "hw4_assets/data/items/level3electricities.json");
        this.load.object("switches", "hw4_assets/data/items/level3switches.json");
        ...
        this.load.object("potions", "hw4_assets/data/items/level3potions.json");
