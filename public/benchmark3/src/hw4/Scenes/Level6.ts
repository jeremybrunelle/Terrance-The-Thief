...
export default class Level6 extends HW4Scene {
    ...
    public override loadScene() {
        ...
        this.load.object("keys", "hw4_assets/data/items/level6keys.json");
        this.load.object("vents", "hw4_assets/data/items/level6vents.json");
        this.load.object("safes", "hw4_assets/data/items/level6safes.json");
        this.load.object("obstacles", "hw4_assets/data/items/level6obstacles.json");
        this.load.object("lockers", "hw4_assets/data/items/level6lockers.json");
        this.load.object("electricities", "hw4_assets/data/items/level6electricities.json");
        this.load.object("switches", "hw4_assets/data/items/level6switches.json");
        ...
        this.load.object("potions", "hw4_assets/data/items/level6potions.json");
    ...
    levelCompleteCheck() {
        ...
        if (this.money > 200) {
            ...
            if (levelComplete) {
                this.emitter.fireEvent(GameEventType.STOP_SOUND, {key: "levelMusic"});
                this.sceneManager.changeToScene(Level6Complete);
            }
        }
    }
