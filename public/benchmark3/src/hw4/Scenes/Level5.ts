...
export default class Level5 extends HW4Scene {
    ...
    public override loadScene() {
        ...
        this.load.object("keys", "hw4_assets/data/items/level5keys.json");
        this.load.object("vents", "hw4_assets/data/items/level5vents.json");
        this.load.object("safes", "hw4_assets/data/items/level5safes.json");
        this.load.object("obstacles", "hw4_assets/data/items/level5obstacles.json");
        this.load.object("lockers", "hw4_assets/data/items/level5lockers.json");
        this.load.object("electricities", "hw4_assets/data/items/level5electricities.json");
        this.load.object("switches", "hw4_assets/data/items/level5switches.json");
        this.load.object("offs", "hw4_assets/data/items/level5offs.json");
        this.load.object("moneybags", "hw4_assets/data/items/level5moneybags.json");
        this.load.object("decoys", "hw4_assets/data/items/level5decoys.json");
        this.load.object("potions", "hw4_assets/data/items/level5potions.json");
        ...
        this.load.audio("levelMusic", "hw4_assets/audio/levelMusic2.mp3");
    ...
    levelCompleteCheck() {
        ...
        if (this.money >= 200) {
            ...
            if (levelComplete) {
                this.emitter.fireEvent(GameEventType.STOP_SOUND, {key: "levelMusic"});
                this.sceneManager.changeToScene(Level5Complete);
            }
        }
    }
